package org.rapidpm.event.frp.m06_reactive.v004_completable_future.v003;
...
public class MainLazy {
  ...
  public static void main(String[] args) {
    ...
    final BiFunction<StepA, StepB, Result> stepAStepBResultBiFunction = getStepAStepBResultBiFunction();
    final BiFunction<StepC, Result, Result> stepCResultResultBiFunction = getStepCResultResultBiFunction();


    final CompletableFuture<StepA> stepACF = supplyAsync(MainLazy::getStepASupplier, executorServiceCPU);
    final CompletableFuture<StepB> stepBCF = supplyAsync(MainLazy::getStepBSupplier, executorServiceNetworkLocalDisk);
